...
@section('content')
    ...
    <div class="my-3">
        <table class="table">
            ...
            <tr>
                @if ($users->isEmpty())
                    <td colspan="4">There are no active users.</td>
            </tr>
        @else
            <tbody>
                @foreach ($users as $item)
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="/destroy-user/{{ $item->slug }}"
                                onclick="return confirm('Are you sure want to ban username {{ $item->username }} ?')"><i
        ...
        <table class="table">
            ...
            <tr>
                @if ($deleteUser->isEmpty())
                    <td colspan="4">There are no deleted users.</td>
            </tr>
        @else
            <tbody>
                @foreach ($deleteUser as $item)
                    <tr>
                        ...
                        <td>{{ $item->phone }}</td>
                        <td>
                            <a href="/restore-user/{{ $item->slug }}"><i
